...
namespace WebFramework.Services.Weixin.MessageHandlers.OpenMessageHandlers
{
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            if (requestMessage.Content.StartsWith("QUERY_AUTH_CODE:"))
            {
                ...
                try
                {
                    ...
                    var sendResult = Senparc.Weixin.MP.AdvancedAPIs.CustomApi.SendText(oauthResult.authorization_info.authorizer_access_token, requestMessage.FromUserName, content);
                }
                catch (Exception)
                {
                    //throw;
