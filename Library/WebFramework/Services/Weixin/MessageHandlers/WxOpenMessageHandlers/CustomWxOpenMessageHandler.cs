...
namespace WebFramework.Services.Weixin.MessageHandlers.WxOpenMessageHandlers
{
    public class CustomWxOpenMessageHandler : WxOpenMessageHandler<CustomWxOpenMessageContext>
    {
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            else if (contentUpper == "CARD")
            {
                ...
                //发送客服消息
                Senparc.Weixin.WxOpen.AdvancedAPIs.CustomApi.SendMiniProgramPage(appId, OpenId, "欢迎使用 Senparc.Weixin SDK", "pages/web/index", uploadResult.media_id);
            }
            else
            {
