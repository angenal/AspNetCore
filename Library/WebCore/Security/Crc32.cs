...
{
    /// <summary>
    /// This is adopted version of C++ fast Crc32 algorithm "Slicing-by-16" (c) Stephan Brumme and Bulat Ziganshin
    ...
    public static class Crc32Algorithm
    {
        ...
        internal unsafe static uint Crc32(byte* dataPtr, int count, uint previousCrc32)
        {
            return BitConverter.IsLittleEndian ?
                Crc32LittleEndian(dataPtr, count, previousCrc32)
                : Crc32BigEndian(dataPtr, count, previousCrc32);
        }
        internal unsafe static uint Crc32LittleEndian(byte* dataPtr, int count, uint previousCrc32)
        {
        ...
        internal unsafe static uint Crc32BigEndian(byte* dataPtr, int count, uint previousCrc32)
        {
            uint crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
            int unroll = 4;
            int bytesAtOnce = 16 * unroll;
        ...
        internal static readonly uint[] Crc32Lookup = new uint[]
        {
