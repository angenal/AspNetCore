...
namespace WebCore.LowMemory
{
    public static class MemoryInformation
    {
        ...
        public static bool DisableEarlyOutOfMemoryCheck =
            string.Equals(Environment.GetEnvironmentVariable("DISABLE_EARLY_OOM"), "true", StringComparison.OrdinalIgnoreCase);

        public static bool EnableEarlyOutOfMemoryCheck =
           string.Equals(Environment.GetEnvironmentVariable("ENABLE_EARLY_OOM"), "true", StringComparison.OrdinalIgnoreCase);
