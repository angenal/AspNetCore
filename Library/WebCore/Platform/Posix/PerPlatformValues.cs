...
using static WebCore.Platform.OS;
    ...
    public class PerPlatformValues
    {
        ...
        public class OpenFlags
        {
            public static Posix.OpenFlags O_DIRECT = (Posix.OpenFlags) (
                IsMacOS ? 0 : // O_DIRECT is not supported in MacOsx, we use fncnlt(F_NOCACHE) instead
            (RuntimeInformation.OSArchitecture == Architecture.Arm ||
             RuntimeInformation.OSArchitecture == Architecture.Arm64)
            ...
            public static Posix.OpenFlags O_LARGEFILE = (Posix.OpenFlags)(
                IsMacOS ? 0 : // O_LARGEFILE is supported by default in MacOsx and this flag doesn't exists in mac
           (RuntimeInformation.OSArchitecture == Architecture.Arm ||
            RuntimeInformation.OSArchitecture == Architecture.Arm64)
