...
namespace Identity.LiteDB
{
    ...
    public class LiteDbUserStore<TUser> : IUserStore<TUser>,
        ...
        IUserAuthenticatorKeyStore<TUser> where TUser : Models.ApplicationUser, new()
    {
        ...
        public LiteDbUserStore(Data.ILiteDbContext dbContext)
        {
        ...
        public Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default)
        {
            ...
            var query = _users.Find(l => l.Claims.Any(c => c.ClaimType == claim.Type && c.ClaimValue == claim.Value));
        ...
        public Task SetTokenAsync(TUser user, string loginProvider, string name, string value, CancellationToken cancellationToken)
        {
            return Task.Run(() =>
            {
                ...
                if (authToken == null)
                {
                    ...
                    user.AddToken(new Models.UserToken<string>
                    {
                        TokenValue = value,
                        TokenName = name,
        ...
        {
            var tokenEntity = user.Tokens.SingleOrDefault(l => l.TokenName == name && l.LoginProvider == loginProvider && l.UserId == user.Id);
        ...
        public Task SetEmailConfirmedAsync(TUser user, bool confirmed, CancellationToken cancellationToken = default)
        {
            ...
            user.EmailConfirmedTime = confirmed ? (DateTime?)DateTime.Now : null;
        ...
        public Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default)
        {
            ...
            return Task.FromResult(_users.FindOne(u => u.NormalizedEmail == normalizedEmail));
        }
        ...
        public Task SetPhoneNumberConfirmedAsync(TUser user, bool confirmed, CancellationToken cancellationToken = default)
        {
            ...
            user.PhoneNumberConfirmedTime = confirmed ? (DateTime?)DateTime.Now : null;
