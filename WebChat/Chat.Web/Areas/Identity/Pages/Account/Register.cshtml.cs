    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    RequiredLength = ((StringLengthAttribute)Attribute.GetCustomAttribute(typeof(InputModel).GetProperty(nameof(Input.Password)), typeof(StringLengthAttribute))).MinimumLength,
